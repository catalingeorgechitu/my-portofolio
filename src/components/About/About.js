...
export default function About() {
	return (
		<section
			id='about'
			className='lg:h-screen snap-start mx-auto flex justify-center items-center'
		>
			<div className='bg-[#1a1c23] flex items-center flex-col w-full py-16 px-5 text-white'>
